...
public class RelatorioGeralEmprestimos 
{
    ...
    public void gerarPDF()
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioGeralEmprestimo"+data2+".pdf";
            ...
            PdfPTable tablesup= new PdfPTable(10);
            
            //Cria celula para o titulo da tabela
                    
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EMPRESTIMOS", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            tablesup.addCell(new Paragraph("DESTINO", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

            tablesup.addCell(new Paragraph("NOME", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

            tablesup.addCell(new Paragraph("DATASAIDA", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

            tablesup.addCell(new Paragraph("DEVOLUCAO", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            tablesup.addCell(new Paragraph("SERIE", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));                

            float[] columnWidths = new float[]{23f, 35f, 23f, 23f,35f,34f,28f,34f,35f,23f};
            ...
            try
            {
                ...
                while(rs.next())
                {
                    ...
                    tablesup.addCell(rs.getString("unidadenome"));
                    tablesup.addCell(rs.getString("nomepessoa"));
                    tablesup.addCell(rs.getString("dataSaida"));
                    tablesup.addCell(rs.getString("dataDevolucao"));
            ...
            Paragraph pcontador = new Paragraph("QUANTIDADE DE EMPRESTIMOS: " + contador, FontFactory.getFont(FontFactory.TIMES_ROMAN, 14f));
